...
from_string(String, Encoding, ErrFn) ->
    ToBytes = case Encoding of
                  ...
                  eucjp_ms -> fun creole_to_eucjp_ms:to_bytes/1;
                  jisx_0208_1983 -> fun creole_to_jisx_0208_1983:to_bytes/1;
                  jisx_0212_1990 -> fun creole_to_jisx_0212_1990:to_bytes/1
              end,
...
to_string(Bytes, Encoding, ErrFn) ->
    Nodes = case Encoding of
                ...
                eucjp_ms -> creole_from_eucjp_ms:da_nodes();                
                jisx_0208_1983 -> creole_from_jisx_0208_1983:da_nodes();
                jisx_0212_1990 -> creole_from_jisx_0212_1990:da_nodes()
            end,
...
to_unicode(<<>>, _, _) ->
    fail;
to_unicode(<<Arc,Bytes/binary>>, Nodes, NodeIndex) ->
